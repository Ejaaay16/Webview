...
<div class="box">
  <div class="ui-card">
    ...
    <div class="description">
        ...
        <a href="<?php echo "teacher_afa_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card1">
    ...
    <div class="description1">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_he_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card2">
    ...
    <div class="description2">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_ia_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card3">
    ...
    <div class="description3">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_ict_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card4">
    ...
    <div class="description4">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_techno_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card5">
    ...
    <div class="description5">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_pie_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div>
  ...
  <div class="ui-card6">
    ...
    <div class="description6">
        ...
        <p>College of Industrial Education</p>
        <a href="<?php echo "teacher_gened_results.php?lgacc=" . $lgd_acc;?>">Upload Results</a>
    </div>
  </div> 
