...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/fishery.css">
...
<div class="box">
  <div class="ui-card">
    ...
    <div class="description">
        ...
        <a href="<?php echo "teacher_agrifish.php?lgacc=" . $lgd_acc;?>">Upload File</a>
    </div>
  </div>
  ...
  <div class="ui-card1">
    ...
    <div class="description1">
        <h3>Practice Test</h3>
        <p>Technology Livelihood Education</p>
        <a href="<?php echo "teacher_afa_exam.php?lgacc=" . $lgd_acc;?>">Upload Exam</a>
    </div>
  </div>
