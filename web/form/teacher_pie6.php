...
$sqlins1 = "INSERT INTO `pie6`(`email`, `fpath`, `fname`) VALUES ('$emadd','$mfile','$fname')";
$stmtins1 = mysqli_prepare($link, $sqlins1);
mysqli_stmt_execute($stmtins1);
mysqli_stmt_close($stmtins1);
unset($_POST);
unset($_FILES);
header("location:teacher_pie6.php?lgacc=" . $lgd_acc);
}
//function getF($link, $lgd_acc){
    $result = $link -> query("SELECT * FROM pie6 WHERE `email`= '" . $lgd_acc . "'");
...
<head> 
  ...
  <title>Building and Enhancing New Literacies Accross the Curriculum </title>  
  ...
  <link rel="stylesheet" type="text/css" href="css/pie6.css">
...
<body>
    <header> 
        ...
        <a href="<?php echo "teacher_Professional.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-label="Upload"  style="color:black !important;">
                            <form action="<?php echo "teacher_pie6.php?lgacc=" . $lgd_acc;?>" method="post" enctype="multipart/form-data">
