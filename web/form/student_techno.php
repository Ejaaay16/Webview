...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/techno.css">
...
<div class="box">
  <div class="ui-card">
    ...
    <div class="description">
        ...
        <a href="<?php echo "student_sts_techno.php?lgacc=" . $lgd_acc;?>">View Content</a>
    </div>
  </div>
  ...
  <div class="ui-card1">
    ...
    <div class="description1">
        <h3>Practice Test</h3>
        <p>Technology Livelihood Education</p>
        <a href="<?php echo "student_techno_exam.php?lgacc=" . $lgd_acc;?>">View Content</a>
    </div>
  </div>
