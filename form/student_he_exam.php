<?php
     ...
     $resultA = $link -> query("SELECT * FROM sts_prof_he WHERE `st_email`= '".$lgd_acc."'");
     ...
     $result = $link -> query("SELECT * FROM he_exam WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/student_he_exam.css">
...
<body>
    <header> 
        ...
        <div class="right_area">
            ...
            <a href="<?php echo "student_home economics.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
