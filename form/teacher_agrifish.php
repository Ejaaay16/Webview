...
$sqlins1 = "INSERT INTO `afa`(`email`, `fpath`, `fname`) VALUES ('$emadd','$mfile','$fname')";
$stmtins1 = mysqli_prepare($link, $sqlins1);
mysqli_stmt_execute($stmtins1);
mysqli_stmt_close($stmtins1);
unset($_POST);
unset($_FILES);
header("location:teacher_agrifish.php?lgacc=" . $lgd_acc);
}
//function getF($link, $lgd_acc){
    $result = $link -> query("SELECT * FROM afa WHERE `email`= '" . $lgd_acc . "'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/afa2.css">
...
<body>
    ...
    <a href="<?php echo "about1.php?lgacc=" . $lgd_acc;?>"  class="About_btn">About</a>
    <a href="<?php echo "Tdashboard.php?lgacc=" . $lgd_acc;?>"class="Menu_btn">Menu</a>
    <a href="<?php echo "glossary1.php?lgacc=" . $lgd_acc;?>" class="Glossary_btn">Glossary</a>
    <a href="<?php echo "notes1.php?lgacc=" . $lgd_acc;?>" class="Notes_btn">Notes</a>
    <a href="<?php echo "record.php?lgacc=" . $lgd_acc;?>" class="Records_btn">Records</a>
    <a href="<?php echo "teacher_AFA.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
                ...
                <tbody>
                    ...
                    <tr>
                        <td data-label="Upload"  style="color:black !important;">
                            <form action="<?php echo "teacher_agrifish.php?lgacc=" . $lgd_acc;?>" method="post" enctype="multipart/form-data">
