                        ...
                        if(isset($_POST['sub1'])){
                            ...
                            foreach($rowsA as $rowA){
                                if($rowA['last_sec'] == $param_sec){
                                    ...
                                    if($param_id == $id){
                                        $resultB = $link -> query("SELECT * FROM sts_prof_gened WHERE `st_email`= '".$rowA['Email Address']."'");
                                        ...
                                        if($cntr > 0){
                                            $sqlup1 = "UPDATE `sts_prof_gened` SET `".$param_sub."` = '".$param_emadd."' WHERE `st_email` = '".$rowA['Email Address']."'";
                                            ...
                                            $sqlup2 = "INSERT INTO `sts_prof_gened`(`st_email`, `".$param_sub."`) VALUES('".$rowA['Email Address']."', '".$param_emadd."')";
...
<body>
 ...
 <div class="box">
    ...
    <div class="main">
    <form action="<?php echo "admin_Gened_prof.php?lgacc=" . $lgd_acc;?>" method="POST">
            <h2 class="first_title">Registration</h2>
            <p class="first_sub_title" id="sub_title">General Education</p>
            <hr />
            <div class="input">
            ...
            <select  id="sub" placeholder="Subject" name="sub" onchange="document.getElementById('sub1').value=this.options[this.selectedIndex].value">
                ...
                <option value="gen1">1.Understanding Self</option>
                <option value="gen2">2.Reading In Philippine History</option>
                <option value="gen3">3.The Contemporary World</option>
                <option value="gen4">4.Mathematics in the Modern World</option>
                <option value="gen5">5.Purposive Communication</option>
                <option value="gen6">6.Art Appreciation</option>
                <option value="gen7">7.Science Technology and Society</option>
                <option value="gen8">8.Ethics</option>
                <option value="exam">9.Practice Test</option>
                <option value="results">10.Results</option>
            </select>
