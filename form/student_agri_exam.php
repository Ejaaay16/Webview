<?php
     ...
     $resultA = $link -> query("SELECT * FROM sts_prof_afa WHERE `st_email`= '".$lgd_acc."'");
     ...
     $result = $link -> query("SELECT * FROM afa_exam WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/agri1.css">
...
<body>
    <header> 
        ...
        <div class="right_area">
            ...
            <a href="<?php echo "student_agri.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
