<?php
     ...
     $resultA = $link -> query("SELECT * FROM sts_prof_pie WHERE `st_email`= '".$lgd_acc."'");
     ...
     $result = $link -> query("SELECT * FROM pie7 WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/profed7.css">
...
<body>
    <header> 
        ...
        <a href="<?php echo "student_about.php?lgacc=" . $lgd_acc;?>" class="About_btn">About</a>
            ...
            <a href="<?php echo "student_PIE.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
