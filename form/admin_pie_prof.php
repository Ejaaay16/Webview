                        ...
                        if(isset($_POST['sub1'])){
                            ...
                            foreach($rowsA as $rowA){
                                if($rowA['last_sec'] == $param_sec){
                                    ...
                                    if($param_id == $id){
                                        $resultB = $link -> query("SELECT * FROM sts_prof_pie WHERE `st_email`= '".$rowA['Email Address']."'");
                                        ...
                                        if($cntr > 0){
                                            $sqlup1 = "UPDATE `sts_prof_pie` SET `".$param_sub."` = '".$param_emadd."' WHERE `st_email` = '".$rowA['Email Address']."'";
                                            ...
                                            $sqlup2 = "INSERT INTO `sts_prof_pie`(`st_email`, `".$param_sub."`) VALUES('".$rowA['Email Address']."', '".$param_emadd."')";
...
<body>
 ...
 <div class="box">
    ...
    <div class="main">
    <form action="<?php echo "admin_pie_prof.php?lgacc=" . $lgd_acc;?>" method="POST">
            <h2 class="first_title">Registration</h2>
            <p class="first_sub_title" id="sub_title">Professional Industrial Education</p>
            <hr />
            <div class="input">
            ...
            <select  id="sub" placeholder="Subject" name="sub" onchange="document.getElementById('sub1').value=this.options[this.selectedIndex].value">
                ...
                <option value="pie1">1.The Child and Adolescent</option>
                <option value="pie2">2.The Teaching Profession</option>
                <option value="pie3">3.Foundation of Technology and Education</option>
                <option value="pie4">4.Facilitating Learner and Centered Teaching</option>
                <option value="pie5">5.Technology Teaching and Learning</option>
                <option value="pie6">6.Build and Enhancing New Literacies Accross the Curriculum</option>
                <option value="pie7">7.Assessment of Learning 1</option>
                <option value="pie8">8.The Teacher and Community Culture</option>
                <option value="pie9">9.Methods of Research</option>
                <option value="pie10">10.Foundation of Special and Inclusive Education</option>
                <option value="pie11">11.Curriculum Development and Evaluation</option>
                <option value="pie12">12.Assessment of Learning 2 </option>
                <option value="pie13">13.Statistics for Educational Research</option>
                <option value="pie14">14.Thesis Writing</option>
                <option value="exam">15.Practice Test</option>
                <option value="results">16.Results</option>
            </select>
