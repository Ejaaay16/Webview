...
<head> 
  ...
  <link rel = "icon" href ="src/tup1.png" type = "image/x-icon">
</head>
...
<body>
  ...
  <div class="sidebar">
    ...
    <a href="<?php echo "student_agri.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-sun-plant-wilt"></i><span>Agri-Fishery Arts</a></span>
    <a href="<?php echo "student_home economics.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-shirt"></i><span>Home Economics</span></a> 
    <a href="<?php echo "student_industrial.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-screwdriver-wrench"></i><span>Industrial Arts</span></a>
    <a href="<?php echo "student_ict.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-computer"></i><span>Information Communication Technology</a></span>
    <a href="<?php echo "student_techno.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-building"></i><span>Technopreneurship</a></span>
    <a href="<?php echo "student_PIE.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-person-chalkboard"></i><span>Professional Industrial Education</a></span>
    <a href="<?php echo "student_GenEd.php?lgacc=" . $lgd_acc;?>"><i class="fa-solid fa-chalkboard"></i><span>General Education</a></span>
</div>
</div>
