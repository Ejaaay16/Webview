<?php
     ...
     $result = $link -> query("SELECT * FROM pie8 WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <title>The Teacher and the Community School Culture </title>  
  ...
  <link rel="stylesheet" type="text/css" href="css/profed8.css">
