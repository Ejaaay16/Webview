<?php
     ...
     $resultA = $link -> query("SELECT * FROM sts_prof_ict WHERE `st_email`= '".$lgd_acc."'");
     ...
     $result = $link -> query("SELECT * FROM ict_exam WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/student_ict_exam.css">
...
<body>
    <header> 
        ...
        <div class="right_area">
            ...
            <a href="<?php echo "student_ict.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
