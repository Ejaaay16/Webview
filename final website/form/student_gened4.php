<?php
     ...
     $resultA = $link -> query("SELECT * FROM sts_prof_gened WHERE `st_email`= '".$lgd_acc."'");
     ...
     $result = $link -> query("SELECT * FROM gen4 WHERE `email`= '".$prof_em."'");
...
<head> 
  ...
  <link rel="stylesheet" type="text/css" href="css/geneduc4.css">
...
<body>
    <header> 
        ...
        <div class="right_area">
            ...
            <a href="<?php echo "student_GenEd.php?lgacc=" . $lgd_acc;?>" class="Subject_btn">Subject</a>
