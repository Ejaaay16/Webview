                        ...
                        if(isset($_POST['sub1'])){
                            ...
                            foreach($rowsA as $rowA){
                                if($rowA['last_sec'] == $param_sec){
                                    ...
                                    if($param_id == $id){
                                        $resultB = $link -> query("SELECT * FROM sts_prof_techno WHERE `st_email`= '".$rowA['Email Address']."'");
                                        ...
                                        if($cntr > 0){
                                            $sqlup1 = "UPDATE `sts_prof_techno` SET `".$param_sub."` = '".$param_emadd."' WHERE `st_email` = '".$rowA['Email Address']."'";
                                            ...
                                            $sqlup2 = "INSERT INTO `sts_prof_techno`(`st_email`, `".$param_sub."`) VALUES('".$rowA['Email Address']."', '".$param_emadd."')";
...
<body>
 ...
 <div class="box">
    ...
    <div class="main">
    <form action="<?php echo "admin_techno_prof.php?lgacc=" . $lgd_acc;?>" method="POST">
            <h2 class="first_title">Registration</h2>
            <p class="first_sub_title" id="sub_title">Technopreneurship</p>
            <hr />
            <div class="input">
            ...
            <select  id="sub" placeholder="Subject" name="sub" onchange="document.getElementById('sub1').value=this.options[this.selectedIndex].value">
                ...
                <option value="techno">1.Technopreneurship</option>
                <option value="exam">.2Practice Test</option>
